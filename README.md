...
Static x86-64 hypervisor workspace (Phases 0–11: config pipeline, platform validation, boot path, ACPI walk, UEFI loader, VMX/EPT/VT-d foundation, UEFI Gate C).
