//! Host re-export coverage for Gate C live execution entry points.

#![allow(clippy::expect_used, clippy::indexing_slicing)]

use hv_config_model::compile_config_from_str;
use hv_hypervisor::boot_from_transfer_and_init_gate_c_live_execution;
...
#[test]
fn hypervisor_live_execution_reexport_runs_without_ring_zero() {
    ...
    let result = boot_from_transfer_and_init_gate_c_live_execution(&transfer, &snapshot, &layout)
        .expect("live execution reexport");
