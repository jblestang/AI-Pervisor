//! Gate D datapath benchmark hypervisor EFI entry tests.
...
#[test]
fn boot_hypervisor_from_transfer_datapath_benchmark_accepts_reference_handoff() {
    ...
    let mut allocator = MockPageAllocator::new(0x0000_0000_1900_0000);
    ...
    .expect("datapath benchmark boot");
    assert!(markers.guests.malicious.integrity_checks_passed);
    assert_eq!(
        markers.guests.elf_images_installed,
