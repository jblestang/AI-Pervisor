//! Gate D datapath foundation hypervisor EFI entry tests.

#![allow(clippy::expect_used, clippy::indexing_slicing)]

use hv_config_model::compile_config_from_str;
use hv_hypervisor_efi::boot_hypervisor_from_transfer_datapath_foundation;
...
#[test]
fn boot_hypervisor_from_transfer_datapath_foundation_accepts_reference_handoff() {
    ...
    let mut allocator = MockPageAllocator::new(0x0000_0000_0D00_0000);
    ...
    .expect("datapath foundation boot");
    assert!(!markers.vmx_launch.vmlaunch_executed);
    assert!(markers.datapath_boot_infos_built);
}
