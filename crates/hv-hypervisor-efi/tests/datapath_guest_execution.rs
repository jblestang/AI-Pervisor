//! Gate D datapath guest execution hypervisor EFI entry tests.
...
#[test]
fn boot_hypervisor_from_transfer_datapath_guest_execution_accepts_reference_handoff() {
    ...
    let mut allocator = MockPageAllocator::new(0x0000_0000_2300_0000);
    ...
    .expect("datapath guest execution boot");
    assert_eq!(markers.live.guest_boot_infos_installed, 3);
