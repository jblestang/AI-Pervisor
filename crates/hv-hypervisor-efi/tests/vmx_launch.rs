//! VMX launch hypervisor EFI entry tests.

#![allow(clippy::expect_used, clippy::indexing_slicing)]

use hv_config_model::compile_config_from_str;
use hv_hypervisor_efi::boot_hypervisor_from_transfer_vmx_launch;
...
#[test]
fn boot_hypervisor_from_transfer_vmx_launch_accepts_reference_handoff() {
    ...
    .expect("vmx launch boot");
    assert!(!markers.vmlaunch_executed);
}
