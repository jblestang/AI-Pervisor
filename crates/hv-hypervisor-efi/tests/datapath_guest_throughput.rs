//! Gate D datapath guest throughput hypervisor EFI entry tests.

#![allow(clippy::expect_used, clippy::indexing_slicing)]

use hv_config_model::compile_config_from_str;
use hv_hypervisor_boot::{layout_snapshot_from_platform_ir, requirements_snapshot_from_platform};
use hv_hypervisor_efi::boot_hypervisor_from_transfer_datapath_guest_throughput;
use hv_loader::{
...
#[test]
fn boot_hypervisor_from_transfer_datapath_guest_throughput_accepts_reference_handoff() {
    ...
    let mut allocator = MockPageAllocator::new(0x0000_0000_2600_0000);
    ...
    .expect("datapath guest throughput boot");
    ...
    assert!(
        markers
            ...
            .sources
            .runtime
            .guest_datapath_frame_forwarded
    );
