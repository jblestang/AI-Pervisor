...
pub use layout_snapshot::{
    ...
    LAYOUT_HOST_NETWORK_IFNAME_LEN, LAYOUT_HOST_NETWORK_NETDEV_LEN,
    MAX_LAYOUT_GUEST_REGIONS, MAX_LAYOUT_HOST_NETWORK_INTERFACES, MAX_LAYOUT_IPC_REGIONS,
    MAX_LAYOUT_PARTITION_ID_LEN, MAX_LAYOUT_PCI_DEVICES,
};
