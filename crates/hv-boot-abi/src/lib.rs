...
pub use constants::{
    ...
    DMAR_SIGNATURE, EFI_MEMORY_CONVENTIONAL, GATE_D_BOOT_INFO_BUILT_MARKER,
    GATE_D_DATAPATH_FOUNDATION_MARKER, GATE_D_DATAPATH_LIVE_MARKER, GATE_D_DATAPATH_MALICIOUS_MARKER,
    GATE_D_DATAPATH_GUESTS_MARKER, GATE_D_DATAPATH_BENCHMARK_MARKER, GATE_D_BENCHMARK_TARGET_MET_MARKER,
    GATE_D_DATAPATH_RUNTIME_MARKER, GATE_D_GUEST_DATAPATH_FRAME_MARKER,
    GATE_D_GUEST_SOURCE_ELF_MARKER, GATE_D_GUEST_BOOT_INFO_INSTALLED_MARKER,
    GATE_D_GUEST_EXECUTION_MARKER, GATE_D_GUEST_THROUGHPUT_MARKER,
    GATE_D_GUEST_THROUGHPUT_TARGET_MET_MARKER, GATE_D_GUEST_THROUGHPUT_EXECUTED_MARKER,
    GATE_D_E1000_MMIO_MARKER, GATE_D_GUEST_ELF_INSTALLED_MARKER,
    GATE_D_IPC_FORWARD_MARKER, GATE_D_IPC_INTEGRITY_MARKER, GATE_D_MULTI_VMLAUNCH_MARKER, REAL_HW_BOOT_SUCCESS_MARKER, REAL_HW_EPT_EXECUTED_MARKER,
    REAL_HW_VMLAUNCH_EXECUTED_MARKER, REAL_HW_VMXON_EXECUTED_MARKER, RSDP_REVISION_ACPI2,
    RSDP_SIGNATURE, UEFI_MEMORY_DESCRIPTOR_MIN_SIZE, UEFI_MEMORY_DESCRIPTOR_OVMF_SIZE,
    UEFI_PAGE_SIZE,
};
