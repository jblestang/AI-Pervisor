...
pub use constants::{
    ...
    GATE_D_DATAPATH_FOUNDATION_MARKER, GATE_D_DATAPATH_LIVE_MARKER, GATE_D_E1000_MMIO_MARKER,
    GATE_D_IPC_FORWARD_MARKER, REAL_HW_BOOT_SUCCESS_MARKER, REAL_HW_EPT_EXECUTED_MARKER,
