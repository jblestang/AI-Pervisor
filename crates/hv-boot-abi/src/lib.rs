...
pub use constants::{
    ...
    DMAR_SIGNATURE, EFI_MEMORY_CONVENTIONAL, REAL_HW_BOOT_SUCCESS_MARKER,
    REAL_HW_EPT_EXECUTED_MARKER, REAL_HW_VMLAUNCH_EXECUTED_MARKER, REAL_HW_VMXON_EXECUTED_MARKER, RSDP_REVISION_ACPI2,
